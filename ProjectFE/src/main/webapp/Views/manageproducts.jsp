...
<!--  
<script type="text/javascript" src="<%= request.getContextPath() %>/resources/js/manageproducts.js"></script> 
-->
...
<body>
 ...
 <div class="container">
   <!--  <div class="row">
        ...
        <div class="row">
          <div class="col-3">
        	<div class="list-group">
        		<a href="${pageContext.request.contextPath}/manageproducts" class="list-group-item list-group-item-action active">Add product</a>
    ...
    <hr>
<div class="col-9">
<form id="login-form" action="${pageContext.request.contextPath}/insertproducts" method="post" role="form" style="display: block;">
