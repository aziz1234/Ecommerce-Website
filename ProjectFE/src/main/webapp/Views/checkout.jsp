...
<html lang="en">
  ...
  <body class="bg-light">
        ...
        <div class="col-md-4 order-md-2 mb-4">
          ...
          <c:forEach items="${products}" var="products">
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              <div>
                <h6 class="my-0"><c:out value="${products.product.productName}" /></h6>
                <small class="text-muted">In <c:out value="${products.product.category}" /></small>
              </div>
              <span class="text-muted">&#x20b9; <c:out value="${products.product.unitPrice}" /></span>
            </li>
            </c:forEach>
    ...
    <script>window.jQuery || document.write('<script src="${pageContext.request.contextPath}/resources/jquery/jquery.slim.min.js"><\/script>')</script>
            ...
            form.addEventListener('submit', function(event) {
              if (form.checkValidity() === false) {
                ...
                event.stopPropagation();
            	  ...
            	  alert("Your delivery is on the way, Thankyou and keep shopping!!")
              }
